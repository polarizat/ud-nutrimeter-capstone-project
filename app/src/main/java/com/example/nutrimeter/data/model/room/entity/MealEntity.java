...
public class MealEntity {
    ...
    public static final String TABLE_NAME = "mealEntities";
    ...
    public MealEntity(int userId, int progressEntryId, String date, int total_kcal, int total_proteins, int total_carbs, int total_fats) {
        this.userId = userId;
