...
@Entity(tableName = Nutrient.TABLE_NAME)
public class Nutrient {
    ...
    public Nutrient(int nmFoodId, int nutrientId, String nutrientName, int nutrientNumber, String unitName, float value) {
    ...
    @Ignore
    public Nutrient(int nmFoodId, AbridgedFoodNutrient abridgedFoodNutrient){
        this.nmFoodId = nmFoodId;
