...
@Entity(tableName = FoodEntity.TABLE_NAME)
public class FoodEntity {

    public static final String TABLE_NAME = "foodEntities";
    ...
    public FoodEntity(int foodId, int fdcId, String dataType, String description, String ndbNumber,
